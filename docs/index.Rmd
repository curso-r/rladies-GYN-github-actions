...
output:
  xaringan::moon_reader:
    ...
    nature:
      ...
      ratio: "16:9"
      slideNumberFormat: "<a href='#sumario'>Sumário</a> - %current%/%total%" 
---
...
- [Revisão sobre GitHub](#revisao-github)
...
- Um workflow tem alguns componentes importantes:
  ...
  - **Event**: gatilhos que ativam o workflow, podendo ser um push no repositório, um horário/dia definido
...
.destaque[será que falar de todos esses conceitos agora não é too much? to pensando em tirar esse slide, pq os mais importantes são explicados depois]
---
...
- Ideia parte 2: no exemplo anterior eu crio a estrutura de pacote, e mostro como criar um actions para fazer 'check'. Você pode pegar desse ponto e implementar um actions para atualizar um Rmd.
]
